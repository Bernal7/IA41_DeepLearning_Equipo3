...
def similitud (usuario1, u2):
    suma = 0
    for item in usuarios[usuario1]:
        if usuarios[usuario1][item] is not None and usuarios[u2][item] is not None:
            suma += math.pow(usuarios[usuario1][item] - usuarios[u2][item],2)
