...
#Graficacion funciones difusas
plt.plot(x_edad, mu_joven, label="Joven", linestyle="--")
plt.plot(x_edad, mu_adulto, label="Adulto", linestyle="--")
plt.plot(x_edad, mu_mayor, label="Mayor", linestyle="--")

#Graficar edades reales
plt.scatter(data["Edad"], data["Mu_Joven"], label="Pertenencia Joven", maker="o")
plt.scatter(data["Edad"], data["Mu_Adulto"], label="Pertenencia Adulto", maker="s")
plt.scatter(data["Edad"], data["Mu_Mayor"], label="Pertenencia Mayor", maker="x")

plt.title("Clasificacion difusa de edades")
plt.xlabel("Edad")
